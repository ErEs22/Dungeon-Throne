...
public class EquipmentLoot : Loot
{
    ...
    public EquipmentItem equipmentLoot;
    ...
    private void OnEnable()
    {
        ...
        icon.sprite = Resources.Load("Sprites/Equipment/" + equipmentLoot.iconName, typeof(Sprite)) as Sprite;
    }
    ...
    {
        equipmentLoot.level = level;
    }

    public override void Collect()
    {
        base.Collect();
        playerInventory?.AddEquipmentItem(equipmentLoot);
